...
public class ShorderController {
    ...
    public JsonResult info(){
        ...
        if(state!=null)
            map.put("state",state);
        OrderDTO order = shorderSrv.getOrderDTO(map);
    ...
    public JsonResult shlist(){
        ...
        List<OrderDTO> purchaseOrder = shorderSrv.getOrderDTOList(map);
	...
	public JsonResult list(){
        ...
        List<OrderDTO> listshorder = shorderSrv.getOrderDTOList(map);
